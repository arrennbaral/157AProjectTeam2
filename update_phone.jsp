...
<div class="container">
    ...
    <label for="old phone"><b>Old Phone Number</b></label>
    <input type="text" placeholder="Old phone number" name="ophone" id="ophone">
    
      <label for="new phone"><b>New Phone Number</b></label>
    <input type="text" placeholder="New phone number" name="nphone" id="nphone">
...
String oldphone=request.getParameter("ophone");
String newphone=request.getParameter("nphone");
...
try {
	...
	String querySql1 = "SELECT phone FROM userInfo WHERE SSN="+ssn+"";
	...
	while(rs1.next())
	{
		...
		%>
		 ...
		 <p style="color:BLue"> Your phone number is successfully updated from <%=oldphone %> to <%=phone %>.
